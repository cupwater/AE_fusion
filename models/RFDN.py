...
class RFDN(nn.Module):
    def __init__(self, in_nc=3, nf=50, num_modules=4, out_nc=3, upscale=4):
        ...
        self.B1 = RFDBBlock(in_channels=nf)
        self.B2 = RFDBBlock(in_channels=nf)
        self.B3 = RFDBBlock(in_channels=nf)
        self.B4 = RFDBBlock(in_channels=nf)
...
if __name__ == '__main__':
    ...
    onnx_path = "sr.onnx"
    dummy_input = torch.randn(1, 3, 960, 540) #.to("cuda")
