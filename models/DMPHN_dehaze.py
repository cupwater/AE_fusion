...
class DMPHN_Dehaze(nn.Module):
    ...
    def forward(self, x_lv1):
        x_lv2 = F.interpolate(x_lv1, scale_factor = 0.5, mode = 'bilinear')
        x_lv3 = F.interpolate(x_lv2, scale_factor = 0.5, mode = 'bilinear')

        feature_lv3 = self.encoder_lv3(x_lv3)
        ...
        feature_lv2 = self.encoder_lv2(x_lv2 + residual_lv3)
        ...
        feature_lv1 = self.encoder_lv1(x_lv1 + residual_lv2)

        dehazed_image = self.decoder_lv1(feature_lv1 + feature_lv2)
